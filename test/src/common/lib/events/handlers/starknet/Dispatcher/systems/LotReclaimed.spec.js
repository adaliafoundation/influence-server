...
const Handler = require('@common/lib/events/handlers/starknet/Dispatcher/systems/LotReclaimed');

describe('LotReclaimed Handler', function () {
  let event;
  ...
  before(function () {
    event = mongoose.model('Starknet')({
      ...
      data: [
        '0x4', '0x1872d600000001',
        '0x1', '0x1',
        '0x123456789'
      ],
      returnValues: {
        lot: { label: 4, id: 6881662889623553 },
