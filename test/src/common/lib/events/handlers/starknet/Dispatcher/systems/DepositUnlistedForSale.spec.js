...
const Handler = require('@common/lib/events/handlers/starknet/Dispatcher/systems/DepositUnlistedForSale');

describe('DepositUnlistedForSale Handler', function () {
  let event;

  beforeEach(function () {
    event = mongoose.model('Starknet')({
      event: 'DepositUnlistedForSale',
      data: [
        '0x7', '0x1',
        '0x1', '0x1',
        '0x123456789'
