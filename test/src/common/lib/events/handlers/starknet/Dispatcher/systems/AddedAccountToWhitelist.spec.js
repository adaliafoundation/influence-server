...
const Handler = require('@common/lib/events/handlers/starknet/Dispatcher/systems/AddedAccountToWhitelist');

describe('AddedAccountToWhitelist Handler', function () {
  let event;

  before(function () {
    event = mongoose.model('Starknet')({
      event: 'AddedAccountToWhitelist',
      logIndex: 1,
