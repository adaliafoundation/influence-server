...
const Handler = require('@common/lib/events/handlers/starknet/Dispatcher/systems/DepositPurchased/v1');

describe('DepositPurchasedV1 Handler', function () {
  let event;
