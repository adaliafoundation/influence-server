...
const Handler = require('@common/lib/events/handlers/starknet/Dispatcher/systems/PrivateSaleAccepted');

describe('PrivateSaleAccepted Handler', function () {
  let event;

  before(function () {
    event = mongoose.model('Starknet')({
      event: 'PrivateSaleOfPrivateSaleAcceptedfered',
      logIndex: 1,
