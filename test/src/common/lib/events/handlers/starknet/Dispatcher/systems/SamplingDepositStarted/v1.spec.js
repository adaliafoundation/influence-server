...
const Handler = require('@common/lib/events/handlers/starknet/Dispatcher/systems/SamplingDepositStarted/v1');
const ResolvableEventNotificationService = require('@common/services/Notifications/Resolvable');

describe('SamplingDepositStarted Handler (v1)', function () {
  let event;
  ...
  afterEach(function () {
    return this.utils.resetCollections([
      ...
      'SamplingDepositNotification', 'StationComponent'
    ]);
  });
