...
const Handler = require('@common/lib/events/handlers/starknet/Dispatcher/systems/PrivateSaleOffered');

describe('PrivateSaleOffered Handler', function () {
  let event;

  before(function () {
    event = mongoose.model('Starknet')({
      event: 'PrivateSaleOffered',
      logIndex: 1,
