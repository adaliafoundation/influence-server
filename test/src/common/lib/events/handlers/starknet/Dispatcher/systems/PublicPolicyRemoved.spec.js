...
const Handler = require('@common/lib/events/handlers/starknet/Dispatcher/systems/PublicPolicyRemoved');

describe('PublicPolicyRemoved Handler', function () {
  let event;

  before(function () {
    event = mongoose.model('Starknet')({
      event: 'PublicPolicyRemoved',
      logIndex: 1,
