...
const Handler = require('@common/lib/events/handlers/starknet/Dispatcher/systems/CrewmateTransferred');

describe('CrewmateTransferred Handler', function () {
  afterEach(function () {
  ...
  describe('processEvent', function () {
    it('should create an Activity Item correctly', async function () {
      const event = mongoose.model('Starknet')({
        event: 'CrewmateTransferred',
        logIndex: 1,
        timestamp: 1695691834,
        transactionIndex: 1,
        transactionHash: '0x123456789',
        returnValues: {
          crewmate: { id: 1, label: 2 },
