...
const Handler = require('@common/lib/events/handlers/starknet/Dispatcher/systems/PrepaidPolicyAssigned');

describe('PrepaidPolicyAssigned Handler', function () {
  let event;

  before(function () {
    event = mongoose.model('Starknet')({
      event: 'PrepaidPolicyAssigned',
      logIndex: 1,
