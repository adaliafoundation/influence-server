...
const Handler = require('@common/lib/events/handlers/starknet/Dispatcher/systems/ShipAssemblyStarted/v1');
const Entity = require('@common/lib/Entity');
const ResolvableEventNotificationService = require('@common/services/Notifications/Resolvable');

describe('ShipAssemblyStartedV1 Handler', function () {
  let event;
  ...
  afterEach(function () {
    return this.utils.resetCollections([
      ...
      'ShipAssemblyNotification', 'StationComponent'
    ]);
  });
