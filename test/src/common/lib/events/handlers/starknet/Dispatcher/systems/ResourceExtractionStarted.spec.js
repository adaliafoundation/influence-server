...
const Handler = require('@common/lib/events/handlers/starknet/Dispatcher/systems/ResourceExtractionStarted');
const ResolvableEventNotificationService = require('@common/services/Notifications/Resolvable');

describe('ResourceExtractionStarted Handler', function () {
  let event;
  ...
  afterEach(function () {
    return this.utils.resetCollections([
      ...
      'ResourceExtractionNotification', 'StationComponent'
    ]);
  });
