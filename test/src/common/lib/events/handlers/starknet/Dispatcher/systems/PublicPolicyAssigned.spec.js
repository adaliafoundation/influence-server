...
const Handler = require('@common/lib/events/handlers/starknet/Dispatcher/systems/PublicPolicyAssigned');

describe('PublicPolicyAssigned Handler', function () {
  let event;

  before(function () {
    event = mongoose.model('Starknet')({
      event: 'PublicPolicyAssigned',
      logIndex: 1,
