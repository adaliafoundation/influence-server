...
const Handler = require('@common/lib/events/handlers/starknet/Dispatcher/systems/PrepaidPolicyRemoved');

describe('PrepaidPolicyRemoved Handler', function () {
  let event;

  before(function () {
    event = mongoose.model('Starknet')({
      event: 'PrepaidPolicyRemoved',
      logIndex: 1,
