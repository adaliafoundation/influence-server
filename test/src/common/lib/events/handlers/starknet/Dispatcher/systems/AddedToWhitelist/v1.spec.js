...
const Handler = require('@common/lib/events/handlers/starknet/Dispatcher/systems/AddedToWhitelist/v1');

describe('AddedToWhitelistV1 Handler', function () {
  let event;

  before(function () {
    event = mongoose.model('Starknet')({
      event: 'AddedToWhitelistV1',
      logIndex: 1,
