...
const Handler = require('@common/lib/events/handlers/starknet/Dispatcher/systems/EmergencyPropellantCollected');

describe('EmergencyPropellantCollected Handler', function () {
  let event;
