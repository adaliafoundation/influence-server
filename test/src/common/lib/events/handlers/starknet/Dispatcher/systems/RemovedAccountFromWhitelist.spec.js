...
const Handler = require('@common/lib/events/handlers/starknet/Dispatcher/systems/RemovedAccountFromWhitelist');

describe('RemovedAccountFromWhitelist Handler', function () {
  let event;

  before(function () {
    event = mongoose.model('Starknet')({
      event: 'RemovedAccountFromWhitelist',
      logIndex: 1,
      ...
      returnValues: {
        entity: { id: 2, label: 1 },
        permission: 1,
        permitted: '0x0000000000000000000000000000000000000000000000000000000123456789',
