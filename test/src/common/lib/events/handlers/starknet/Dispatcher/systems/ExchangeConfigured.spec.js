...
const Handler = require('@common/lib/events/handlers/starknet/Dispatcher/systems/ExchangeConfigured');

describe('ExchangeConfigured Handler', function () {
  let event;

  before(function () {
    event = mongoose.model('Starknet')({
      event: 'ExchangeConfigured',
  ...
  describe('processEvent', function () {
    it('should create an Activity Item correctly', async function () {
      ...
      expect(activityDocs[0].entities).to.have.lengthOf(2);
    });
  });
