...
const Handler = require('@common/lib/events/handlers/starknet/Dispatcher/components/Processor/v1');

describe('ComponentUpdated: Processor Handler (v1)', function () {
  let event;
  const stubs = {
  ...
  beforeEach(function () {
    event = mongoose.model('Starknet')({
      ...
      returnValues: {
        ...
        secondaryEff: 2.3283064365386963e-10,
