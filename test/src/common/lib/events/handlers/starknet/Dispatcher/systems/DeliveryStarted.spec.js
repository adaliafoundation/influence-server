...
const Handler = require('@common/lib/events/handlers/starknet/Dispatcher/systems/DeliveryStarted');

describe('DeliveryStarted Handler', function () {
  let event;
  ...
  describe('hashKeys', function () {
    it('should return the correct hashKeys', function () {
      expect(Handler.hashKeys).to.deep.equal(['name', 'returnValues.delivery.id']);
    });
  });
