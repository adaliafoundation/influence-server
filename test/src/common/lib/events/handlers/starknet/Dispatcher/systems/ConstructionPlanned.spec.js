...
const Handler = require('@common/lib/events/handlers/starknet/Dispatcher/systems/ConstructionPlanned');

describe('ConstructionPlanned Handler', function () {
  let event;
  let updateSub;
