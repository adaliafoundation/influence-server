...
const Handler = require('@common/lib/events/handlers/starknet/Dispatcher/systems/ConstructionAbandoned');

describe('ConstructionAbandoned Handler', function () {
  let event;
  let updateSub;
  ...
  beforeEach(async function () {
    ...
    updateSub = this._sandbox.stub(PackedLotDataService, 'updateBuildingTypeForLot').resolves();
  ...
  describe('processEvent', function () {
    ...
    it('should update the packed lot data', async function () {
      ...
      expect(updateSub.calledOnceWith(Entity.Lot(4295217296))).to.eql(true);
    });
  });
