...
const Handler = require('@common/lib/events/handlers/starknet/Crewmate/Transfer');

describe('Starknet::Crewmate::Transfer Handler', function () {
  let event;
  ...
  describe('processEvent', function () {
    ...
    it('should create an NftComponent document', async function () {
