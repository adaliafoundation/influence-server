...
const Handler = require('@common/lib/events/handlers/starknet/Ship/SellOrderSet');

describe('Ship::SellOrderSet Handler', function () {
  let event;
  ...
  describe('processEvent', function () {
    ...
    it('should update the NftComponent document', async function () {
      ...
      expect(nftCompDoc.price).to.equal(event.returnValues.price);
    });
