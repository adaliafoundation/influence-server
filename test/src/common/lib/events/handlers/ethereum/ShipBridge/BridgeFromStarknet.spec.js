...
const Handler = require('@common/lib/events/handlers/ethereum/ShipBridge/BridgeFromStarknet');

describe('ShipBridge::BridgeFromStarknet Handler', function () {
  let event;
  ...
  describe('processEvent', function () {
    ...
    it('should update the NftComponent document, if current event is newer', async function () {
      ...
      const nftCompDoc = await mongoose.model('NftComponent').findOne({ 'entity.uuid': Entity.Ship(1).uuid });
