...
const Handler = require('@common/lib/events/handlers/ethereum/CrewBridge/BridgeFromStarknet');

describe('CrewBridge::BridgeFromStarknet Handler', function () {
  let event;
  ...
  beforeEach(function () {
    event = mongoose.model('Ethereum')({
      ...
      returnValues: {
        ...
        l1Contract: appConfig.get('Contracts.ethereum.crewBridge'),
