...
const Handler = require('@common/lib/events/handlers/ethereum/CrewmateBridge/BridgeFromStarknet');

describe('CrewmateBridge::BridgeFromStarknet Handler', function () {
  let event;
