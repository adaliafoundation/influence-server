...
class ActivateEmergencyHandler extends BaseActionHandler {
  // eslint-disable-next-line class-methods-use-this
  getEventName() { return 'EmergencyActivated'; }
  ...
  getDispatcherSystemHandler() {
    ...
    return require('@common/lib/events/handlers/starknet/Dispatcher/systems/EmergencyActivated');
  }
}

module.exports = ActivateEmergencyHandler;
