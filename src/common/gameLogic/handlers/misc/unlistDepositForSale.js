...
class UnlistDepositForSaleHandler extends BaseActionHandler {
  // eslint-disable-next-line class-methods-use-this
  getEventName() { return 'DepositUnlistedForSale'; }
  ...
  getDispatcherSystemHandler() {
    ...
    return require('@common/lib/events/handlers/starknet/Dispatcher/systems/DepositUnlistedForSale');
  }
}

module.exports = UnlistDepositForSaleHandler;
