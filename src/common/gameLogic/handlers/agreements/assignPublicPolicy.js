...
class AssignPublicPolicyHandler extends BaseActionHandler {
  // eslint-disable-next-line class-methods-use-this
  getEventName() { return 'PublicPolicyAssigned'; }
  ...
  getDispatcherSystemHandler() {
    ...
    return require('@common/lib/events/handlers/starknet/Dispatcher/systems/PublicPolicyAssigned');
  }
}

module.exports = AssignPublicPolicyHandler;
