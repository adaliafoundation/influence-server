...
class WhitelistAccountHandler extends BaseActionHandler {
  // eslint-disable-next-line class-methods-use-this
  getEventName() { return 'AddedAccountToWhitelist'; }
  ...
  async applyStateChanges() {
    await this.writeComponent('WhitelistAccountAgreement', {
  ...
  getDispatcherSystemHandler() {
    ...
    return require('@common/lib/events/handlers/starknet/Dispatcher/systems/AddedAccountToWhitelist');
  }
}

module.exports = WhitelistAccountHandler;
