...
class WhitelistHandler extends BaseActionHandler {
  // eslint-disable-next-line class-methods-use-this
  getEventName() { return 'AddedToWhitelist'; }
  ...
  getDispatcherSystemHandler() {
    ...
    return require('@common/lib/events/handlers/starknet/Dispatcher/systems/AddedToWhitelist/v1');
  }
}
