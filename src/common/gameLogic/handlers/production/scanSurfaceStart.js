...
class ScanSurfaceStartHandler extends BaseActionHandler {
  // eslint-disable-next-line class-methods-use-this
  getEventName() { return 'SurfaceScanStarted'; }
  ...
  async validate() {
    ...
    // 2. Asteroid must exist and be UNSCANNED
  ...
  getDispatcherSystemHandler() {
    ...
    return require('@common/lib/events/handlers/starknet/Dispatcher/systems/SurfaceScanStarted');
  }
}

module.exports = ScanSurfaceStartHandler;
