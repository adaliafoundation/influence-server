...
class CreateBuyOrderHandler extends BaseActionHandler {
  ...
  getEventName() { return 'BuyOrderCreated'; }
  ...
  async validate() {
    ...
    // 3. Load storage inventory for reservation
  ...
  async applyStateChanges() {
    ...
    // Reserve space in destination inventory for the products we'll receive
    if (this.storageInv) {
  ...
  getDispatcherSystemHandler() {
    ...
    return require('@common/lib/events/handlers/starknet/Dispatcher/systems/BuyOrderCreated');
  }
}

module.exports = CreateBuyOrderHandler;
